				...
				<div class="collapse in" id="panel_pedidos">
					<div class="panel-body" id="panel_pedidos_body">
						<div class="panel-group">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<strong>Pedidos de Hospedagem</strong> <span id="panel1-qtd" class="label label-primary"><?php echo $total_pedidos;?></span> <a class="pull-right" id="panel1-btn-link" data-toggle="collapse" data-target="#panel1">[+] Mostrar</a>
								</div>
...
DADOS;
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<strong>Acomodações</strong> <span id="panel2-qtd" class="label label-primary"><?php echo $total_acomod; ?></span> <a class="pull-right" id="panel2-btn-link" data-toggle="collapse" data-target="#panel2">[+] Mostrar</a>
								</div>
