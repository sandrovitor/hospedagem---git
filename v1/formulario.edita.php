...
DADOS;
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" name="congresso_cidade" id="congresso_cidade" class="form-control" value="<?php echo $reg->congresso_cidade;?>" required>
							</div>
							
							<div class="form-group">
								<label for="check_in">Primeira noite que precisará do quarto:</label>
								<input type="date" name="check_in" id="check_in" class="form-control" value="<?php echo $reg->check_in?>" required>
							</div>
							
							<div class="form-group">
								<label for="check_out">Última noite que precisará do quarto:</label>
								<input type="date" name="check_out" id="check_out" class="form-control" value="<?php echo $reg->check_out;?>" required>
							</div>
