				...
				<div class="col-xs-12 col-sm-4">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<a class="btn btn-link" href="admin.php?page=4"><span class="glyphicon glyphicon-search"></span> Listar usuários</a><br>
				...
				<div class="col-xs-12 col-sm-4">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<a class="btn btn-link" href="admin.php?page=22"><span class="glyphicon glyphicon-refresh"></span> Redefinir</a><br>
