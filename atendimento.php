    			...
    			<ul class="navbar-nav mr-auto">
    				...
    				<li class="nav-item dropdown">
						...
						<div class="dropdown-menu">
                        	...
                        	<a class="dropdown-item active scrollSuave" href="atendimento.php"><span class="glyphicon glyphicon-headphones"></span> Atendimento</a>
...
<!-- CONTEUDO -->
	...
	<div class="row">
		<div class="col-12">
			<input type="text" class="form-control" id="input_filter" onkeyup="filterAtendimento()" placeholder="Pesquisar na tabela...">
			<br>
			<?php echo $sistema->pageAtendimento();?>
		</div>
	</div>
	<!-- Modal -->
    	   ...
    	   <!-- Modal content-->
    		<div class="modal-content">
    			<div class="modal-header">
    				<h4 class="modal-title"><strong>Informações</strong></h4>
    				<button type="button" class="close" data-dismiss="modal">&times;</button>
    			</div>
    			<div class="modal-body" id="atendimento_modal">
